...
pub const MyMetalDevice = ?*anyopaque;
pub const MyMetalPipeline = ?*anyopaque;
pub const MyMetalBuffer = ?*anyopaque;
pub extern fn bridge_create_device(...) MyMetalDevice;
pub extern fn bridge_get_device_name(device: MyMetalDevice, out_name: [*c]u8) void;
pub extern fn bridge_release_device(device: MyMetalDevice) void;
pub extern fn bridge_create_compute_pipeline(device: MyMetalDevice, function_name: [*c]const u8) MyMetalPipeline;
pub extern fn bridge_create_render_pipeline(device: MyMetalDevice, vert_fn_name: [*c]const u8, frag_fn_name: [*c]const u8) MyMetalPipeline;
pub extern fn bridge_create_buffer(device: MyMetalDevice, data: [*c]f32, count: usize) MyMetalBuffer;
pub extern fn bridge_create_buffer_nocopy(device: MyMetalDevice, data: [*c]f32, count: usize) MyMetalBuffer;
pub extern fn bridge_run_adder(device: MyMetalDevice, pipeline: MyMetalPipeline, bufA: MyMetalBuffer, bufB: MyMetalBuffer, bufC: MyMetalBuffer, count: usize) void;
pub extern fn bridge_draw_frame(device: MyMetalDevice, pipeline: MyMetalPipeline, vertex_buf: MyMetalBuffer, current_drawable: ?*anyopaque) void;
