...
pub fn build(b: *std.Build) void {
    ...
    // 2. Create the install step
    // This will copy the file to {prefix}/bin/default.metallib
    const install_lib = b.addInstallFile(metallib_path, "bin/default.metallib");

    // 3. Make the main 'install' step depend on this copy operation
